...
Status: Currently focused on offensive security projects and writeups
```
...
```
Current Projects:
1. ACLGuard - Active Directory ACL risk discovery
2. YouTube Channel (Coming Soon) - Walkthroughs and tooling notes
3. Reverse Engineering & Binary Exploitation - Writeups and walkthroughs
```
