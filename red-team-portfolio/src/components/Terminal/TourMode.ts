...
export class TourMode {
  ...
  private readonly steps: TourStep[] = [
    ...
    {
      type: 'narrative',
      narrative: `I'm building three interconnected tools that form a complete Red Team toolkit. Each one demonstrates different aspects of offensive security and automation. Press ENTER to see what I'm working on...`,
      nextStep: 3
    },
    {
      type: 'command',
    ...
    {
      type: 'narrative',
      narrative: `If you're hiring for red team operations or need penetration testing services, I'd love to connect! I'm actively seeking opportunities in the $50-70k range and offer professional security assessments. Type 'contact' anytime to reach out, or press ENTER to finish the tour.`,
      nextStep: 8
    },
    {
      type: 'complete',
