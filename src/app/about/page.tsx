...
const achievements = [
  { metric: '6', title: 'Portfolio Projects', description: 'Security tooling, labs, and writeup hubs' },
  { metric: '42', title: 'Writeups & Notes', description: 'CTF, reversing, and exploitation walkthroughs' },
  { metric: '3', title: 'Certifications', description: 'AD-RTS + CAPT + COSJ' },
  { metric: '25+', title: 'Terminal Commands', description: 'Interactive portfolio exploration' },
  { metric: '3', title: 'Focus Areas', description: 'AD security, tooling, reverse engineering' },
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Offensive security practitioner building real tools, writeups, and lab workflows
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                A structured approach to building offensive security depth through projects and writeups
              </p>
            </motion.div>
              ...
              <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-8">
                ...
                <div className="prose prose-invert max-w-none">
                  <p className="text-lg text-gray-300 mb-6">
                    I focus on red team operations through a <strong className="text-red-400">build-first approach</strong> - 
                    creating real tools, conducting research, and documenting practical skills.
                  </p>
                  <p className="text-lg text-gray-300 mb-6">
                    This achievement-focused approach centers on hands-on learning, building projects that matter, and developing the technical 
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-300">
                      ...
                      <li>• CRT-ID (Red Team Infra Dev)</li>
                      <li>• BTF (Blue Team Fundamentals)</li>
                      <li>• PTF (Purple Teaming Fundamentals)</li>
                      <li>• CPIA (Process Injection Analyst)</li>
                      <li>• CRT-COI (CredOps Infiltrator)</li>
                      <li>• CWSE (Certified Web Security Expert)</li>
                    </ul>
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-4">Completed</h3>
                    <ul className="space-y-2 text-gray-300">
                      <li>• Active Directory Red Team Specialist (CyberWarfare Labs)</li>
                      <li>• Certified Associate Penetration Tester (HackViser)</li>
                      <li>• Certified Offensive Security Junior (RedTeam Ops)</li>
                    </ul>
                  </div>
                </div>
              </div>
