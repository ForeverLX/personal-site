...
const trustPoints = [
  {
    title: 'Hands-On Work',
    description: 'Building real tools, labs, and writeups with repeatable methodology.'
  },
  {
    title: 'Transparent Process',
    description: 'Clear scope, honest status updates, and documentation-first execution.'
  },
  {
    title: 'Collaboration Friendly',
    description: 'Open to reviews, research partnerships, and project collaboration.'
  }
]
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Looking to collaborate on security research, writeups, or tooling? Let's connect.
              </p>
            </motion.div>
          </div>
        </section>
