...
export default function ToolsSection() {
  const projects = [
    ...
    },
    {
      ...
      description: 'Coming soon: deep-dive walkthroughs of offensive workflows and tooling decisions.',
      icon: '🎬',
      color: 'blue',
    ...
    },
    {
      ...
      description: 'Writeups and walkthroughs focused on reversing, shellcode, and exploitation fundamentals.',
      icon: '🧩',
      color: 'purple',
