...
${colors.cyan}Navigation:${colors.reset}
  ...
  contact     - Get in touch for opportunities or collaboration
...
${colors.red}▸${colors.reset} Current focus: reverse engineering writeups and labs
...
${colors.bold}"I'm documenting my transition into red team operations
through production-quality code and transparent learning."${colors.reset}
...
I'm on a 90-day intensive journey to build real-world red team skills.
Instead of collecting certifications alone, I'm building production-quality
security tools and documenting everything publicly.
...
Land a Red Team or Security Engineer role by demonstrating
...
Week 7 - Preparing long-form walkthrough content and tooling deep dives.
...
${colors.cyan}Type 'contact' if you're hiring or want to collaborate${colors.reset}
`;
...
Core focus areas and projects:

${colors.blue}1. ACLGuard${colors.reset} - AD ACL risk discovery
   ${colors.red}▸${colors.reset} Status: Active Development
   ${colors.red}▸${colors.reset} Tech: C, LDAP, Active Directory
   ${colors.red}▸${colors.reset} Purpose: AD permissions auditing & attack surface
   ${colors.red}▸${colors.reset} Features: Risky ACE detection, mock/LDAP modes
   ${colors.red}▸${colors.reset} GitHub: github.com/ForeverLX/ACLGuard-Active-Directory-Permission-Auditor

${colors.blue}2. YouTube Channel${colors.reset} - Walkthroughs (Coming Soon)
   ${colors.red}▸${colors.reset} Status: Planned
   ${colors.red}▸${colors.reset} Focus: Offensive workflows, tooling decisions
   ${colors.red}▸${colors.reset} Topics: AD tradecraft, reverse engineering, writeups

${colors.blue}3. Reverse Engineering & Binary Exploitation${colors.reset} - Writeups & walkthroughs
   ${colors.red}▸${colors.reset} Status: Active
   ${colors.red}▸${colors.reset} Tech: GDB, assembly, reversing
   ${colors.red}▸${colors.reset} Focus: Methodology, verification, tooling
   ${colors.red}▸${colors.reset} GitHub: github.com/ForeverLX/security-portfolio
...
${colors.red}▸ Programming & Development${colors.reset}
  ${colors.red}├─${colors.reset} C (systems programming, reversing, exploitation)
...
${colors.red}▸ Learning & Certifications${colors.reset}
  ${colors.red}├─${colors.reset} AD-RTS (CyberWarfare Labs) - Completed
  ${colors.red}├─${colors.reset} CAPT (HackViser) - Completed
  ${colors.red}├─${colors.reset} COSJ (RedTeam Ops) - Completed
  ${colors.red}├─${colors.reset} MCRTA (CyberWarfare Labs) - In Progress
  ${colors.red}├─${colors.reset} CRTA (CyberWarfare Labs) - In Progress
  ${colors.red}├─${colors.reset} CRT-ID (CyberWarfare Labs) - In Progress
  ${colors.red}├─${colors.reset} BTF (CyberWarfare Labs) - In Progress
  ${colors.red}├─${colors.reset} PTF (CyberWarfare Labs) - In Progress
  ${colors.red}├─${colors.reset} CPIA (CyberWarfare Labs) - In Progress
  ${colors.red}├─${colors.reset} CRT-COI (CyberWarfare Labs) - In Progress
  ${colors.red}└─${colors.reset} CWSE (CyberWarfare Labs) - In Progress
...
${colors.magenta}Current Build:${colors.reset} Writeups + Reverse Engineering
...
${colors.red}darrius   2048  32.0  18.0  1536M  384M pts/1    S+   Oct15   89:47 content-planning --recording --review${colors.reset}
