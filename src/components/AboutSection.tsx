...
export default function AboutSection() {
  ...
  const certifications = [
    { name: 'MCRTA', status: 'In Progress', expected: '2026' },
    { name: 'CRTA', status: 'In Progress', expected: '2026' },
    { name: 'CRT-ID', status: 'In Progress', expected: '2026' },
    { name: 'BTF', status: 'In Progress', expected: '2026' },
    { name: 'PTF', status: 'In Progress', expected: '2026' },
    { name: 'CPIA', status: 'In Progress', expected: '2026' },
    { name: 'CRT-COI', status: 'In Progress', expected: '2026' },
    { name: 'CWSE', status: 'In Progress', expected: '2026' }
  ]
        ...
        <div className="grid lg:grid-cols-3 gap-12 mb-20">
          ...
          >
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Offensive security practitioner focused on Active Directory, tool development, and research.
              Building practical skills through real tooling and writeups.
            </p>
          </motion.div>
          ...
          >
            <div className="bg-gray-800/30 rounded-lg border border-gray-700/50 backdrop-blur-sm p-8">
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed">
                <p>
                  My transition into red team operations is grounded in building and documenting real work.
                  I focus on repeatable methodology, strong technical foundations, and proof through execution.
                </p>
                <p>
                  With 6 portfolio projects and 42 writeups, I'm building depth in Active Directory security, C programming, and reverse engineering.
                  The focus is on clarity, verification, and repeatable outcomes.
                </p>
                <p>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <div className="text-gray-300 text-sm">Portfolio Projects</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-400 mb-2">42</div>
              <div className="text-gray-300 text-sm">Writeups & Notes</div>
            </div>
            <div className="text-center">
