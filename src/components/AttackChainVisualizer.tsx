...
const attackChain = [
  ...
  },
  {
    ...
    description: 'Writeups focused on reversing and exploitation fundamentals',
    features: [
      'GDB-driven analysis',
      'Shellcode exercises',
  ...
  {
    id: 'writeups',
    name: 'Writeups & Research',
    phase: 'Documentation',
    description: 'Lab writeups with evidence, impact, and mitigations',
    features: [
      ...
      <div className="relative z-50 max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Three portfolio pillars covering tooling, analysis, and documentation
          </p>
        </motion.div>
